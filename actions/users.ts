...
export async function createUser(formData: RegisterInputProps) {
  ...
  try {
    if (isEmailBlacklisted(email)) {
      return {
        error: `Por favor, utilice una dirección de correo electrónico válida.`,
        status: 409,
        data: null,
      };
    }
    ...
    const linkText = "Verifica tu cuenta ";
    const message =
      "Gracias por unirte a Telemedicina. Para completar tu registro y verificar tu dirección de correo electrónico, por favor ingresa el siguiente código de verificación de 6 dígitos en nuestro sitio web :";
