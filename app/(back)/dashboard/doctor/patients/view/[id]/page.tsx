  ...
  return (
    <div className="p-4">
      <Tabs defaultValue="details" className="w-full">
        <TabsList>
          <TabsTrigger value="details">Información del Paciente</TabsTrigger>
        ...
        <TabsContent value="details">
          <div className="p-4">
            <SubHeading title="Información del Paciente" />
            <div className="grid grid-cols-1 md:grid-cols-2  gap-4">
              ...
              <div className="flex items-center">
                <span className="mr-3">Apellido :</span>
                <span>{patientDetails.lastName}</span>
              </div>
              <div className="flex items-center">
                <span className="mr-3">Número de teléfono :</span>
              ...
              <div className="flex items-center">
                <span className="mr-3">Ubicación :</span>
                <span>{patientDetails.location}</span>
              </div>
              <div className="flex items-center">
                <span className="mr-3">Ocupación :</span>
            ...
            <div className="py-4 space-y-3">
              <div className="flex flex-col">
                <SubHeading title="Doctores del Paciente" />
        ...
        <TabsContent value="appointments">
          <div className="p-4">
            <h2 className="border-b pb-3 mb-3">
              Citas ({appointments.length.toString().padStart(2, "0")})
            </h2>
