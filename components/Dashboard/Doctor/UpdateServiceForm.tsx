    ...
    <>
      <CardContent className="space-y-3">
          ...
          <div className="sm:col-span-4">
            <div className="flex items-center justify-between border-b">
              <h2 className="scroll-m-20 text-xl font-semibold tracking-tight py-2 mb-3">
                Actualizar Precio por hora
              </h2>
              <Button disabled={savingPrice} onClick={handleUpdatePrice}>
                {savingPrice ? "Guardando por favor espera..." : "Actualizar Precio"}
              </Button>
            </div>
            <div className=" mt-2">
        ...
        <div className="border shadow rounded-md p-4 mt-4">
          <div className="flex items-center justify-between border-b">
            ...
            <Button disabled={savingMode} onClick={handleUpdateMode}>
              {savingMode ? "Guardando por favor espera..." : "Actualizar Modo de Operación"}
            </Button>
          </div>
        ...
        <div className="border shadow rounded-md p-4 mt-4">
          <div className="flex items-center justify-between border-b">
            <h2 className="scroll-m-20 text-xl font-semibold tracking-tight py-2 mb-3">
              Servicio que deseas ofrecer
            </h2>
            <Button disabled={savingServices} onClick={handleUpdateService}>
              {savingServices ? "Guardando por favor espera..." : "Actualizar Servicio"}
            </Button>
          </div>
          <div className="grid grid-cols-4 gap-2 py-3">
            {services &&
        ...
        <div className="border shadow rounded-md p-4">
          <div className="flex items-center justify-between border-b">
            ...
            <Button disabled={savingSpecialty} onClick={handleUpdateSpecialty}>
              {savingSpecialty ? "Guardando por favor espera..." : "Actualizar Especialidad"}
            </Button>
          </div>
          <div className="grid grid-cols-4 gap-2 py-3">
            {specialties &&
        ...
        <div className="border shadow rounded-md p-4">
          <div className="flex items-center justify-between border-b">
            ...
            <Button disabled={savingSymptoms} onClick={handleUpdateSymptoms}>
              {savingSymptoms ? "Guardando por favor espera..." : "Actualizar Sintomas"}
            </Button>
          </div>
          <div className="grid grid-cols-4 gap-2 py-3">
            {symptoms &&
