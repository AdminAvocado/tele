  ...
  const steps = [
    {
      ...
      component: (
        <BioDataForm
          userId={id}
          title="Información Básica"
          description="Por favor, complete su Información Básica"
          page={page}
          nextPage="profile"
    ...
    },
    {
      ...
      component: (
        <ProfileInfoForm
          title="Información del Perfil"
          description="Por favor, complete su Información del Perfil"
          page={page}
          nextPage="contact"
    ...
    {
      title: "Información de Educación",
      page: "education",
      component: (
        <EducationInfo
          ...
          page={page}
          title="Información de Educación"
          description="Por favor, complete su Información de Educación"
          nextPage="practice"
          formId={doctorProfile.id ? doctorProfileId : savedDBData.id}
          userId={id}
          doctorProfile={doctorProfile}
    ...
    {
      title: "Información de Práctica",
      page: "practice",
      component: (
        <PracticeInfo
          page={page}
          title="Información de Práctica"
          description="Por favor, complete su Información de Práctica"
          nextPage="additional"
          formId={doctorProfile.id ? doctorProfileId : savedDBData.id}
          userId={id}
          doctorProfile={doctorProfile}
      ...
      <div className="col-span-full sm:col-span-9  p-4">
        ...
        {savedDBData.id && (
          <p className="border-b border-gray-200 dark:border-slate-600 text-teal-600 dark:text-teal-400 pb-2">
            ...
            <span className="text-xs">
              (Usa este número para verificar el estado o reanudar la
              aplicación)
            </span>
          </p>
        )}
