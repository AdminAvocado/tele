      ...
      <div className="flex items-center justify-center py-12">
        <div className="mx-auto grid w-[400px] gap-6">
          ...
          <div className="grid gap-2 ">
            <h1 className="text-3xl font-bold">Inicia Sesión en tu Cuenta</h1>
          ...
          <form className="grid gap-4" onSubmit={handleSubmit(onSubmit)}>
            {showNotification && (
              <Alert color="failure" icon={HiInformationCircle}>
                <span className="font-medium">Error al iniciar sesión!</span> Por favor verifica tus credenciales
              </Alert>
            )}
            <TextInput
            ...
            <SubmitButton
              ...
              isLoading={isLoading}
              loadingTitle="Iniciando Sesión, por favor espera..."
            />
          </form>
